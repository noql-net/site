        ...
        <ol className="text-green-300 text-left space-y-6">
          <li className="flex items-start w-full">
            ...
            <div className="w-full">
              <p className="font-semibold text-green-100 mb-1">Step 1: Install Scoop</p>
              <p>Install <a href="https://scoop.sh" target="_blank" className="text-green-400 hover:text-green-300 font-medium hover:underline transition-colors">Scoop</a> on your Windows device</p>
            </div>
          </li>
          <li className="flex items-start w-full">
            <div className="bg-green-800/40 rounded-full p-2 mr-4 mt-1">
            ...
            <div className="w-full">
              ...
              <div className="bg-black/30 p-2 rounded-md mt-2 flex items-center justify-between w-full">
                <code className="text-xs text-green-400/70 font-mono break-all">scoop bucket add noql https://github.com/noql-net/scoop</code>
                <CopyButton textToCopy='scoop bucket add noql https://github.com/noql-net/scoop' contentName="Command" />
              </div>
            </div>
          </li>
          <li className="flex items-start w-full">
            ...
            <div className="w-full">
              <p className="font-semibold text-green-100 mb-1">Step 3: Install Package</p>
              <div className="bg-black/30 p-2 rounded-md mt-2 flex items-center justify-between w-full">
                <code className="text-xs text-green-400/70 font-mono break-all">scoop install noql/v2ray-core</code>
                <CopyButton textToCopy='scoop install noql/v2ray-core' contentName="Command" />
              </div>
            </div>
          </li>
          </ol>
