      ...
      <div className="container relative flex max-w-3xl flex-col items-center gap-8 text-center pb-16">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center gap-4">
            <DiAndroid className="h-12 w-12 text-[var(--color-icon)]" />
          ...
          <p className="text-xl text-[var(--color-subheading)] max-w-2xl mx-auto">
            A curated F-Droid repository containing various Android apps
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-accent)] mt-1">
                  Or manually add the repository by copying the information
                  below and pasting it into the repository manager
                </p>
