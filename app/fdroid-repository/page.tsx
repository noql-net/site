...
import { FiDownload, FiGlobe, FiPlus, FiRefreshCw, FiSearch, FiDownloadCloud } from 'react-icons/fi';
    ...
    <div className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-[#0B1F0B] text-green-50 p-4 pt-8">
      ...
      <div className="container relative flex max-w-3xl flex-col items-center gap-8 text-center pb-16">
        ...
        <div className="bg-green-900/30 border border-green-800/50 rounded-lg p-6 space-y-4 w-full max-w-2xl">
          <h2 className="text-2xl font-semibold text-green-200 mb-4">Repository Features</h2>
        ...
        <div className="bg-green-900/30 border border-green-800/50 rounded-lg p-8 w-full max-w-2xl shadow-lg">
          <h2 className="text-2xl font-bold text-green-200 mb-6 text-center border-b border-green-800/50 pb-3">Installation Guide</h2>
          <ol className="text-green-300 text-left space-y-6">
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 1: Install F-Droid</p>
                <p>Install <a href="https://f-droid.org" target="_blank" className="text-green-400 hover:text-green-300 font-medium hover:underline transition-colors">F-Droid</a> or <a href="https://f-droid.org/packages/com.looker.droidify/" target="_blank" className="text-green-400 hover:text-green-300 font-medium hover:underline transition-colors">Droidify</a> on your Android device</p>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 2: Access Repository</p>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 3: Add Repository</p>
                <p>Tap on <a
                ...
                >this link</a> to add the noql.net repository to F-Droid or Droidify</p>
                <p className="text-sm text-green-500/60 mt-1">Or manually add the repository by copying the information below and pasting it into the repository manager</p>
                <div className="bg-black/30 p-2 rounded-md mt-2 flex items-center justify-between scale-95 transform">
                  <code className="text-xs text-green-400/70 font-mono break-all">https://fdroid.noql.net</code>
                  <CopyButton textToCopy="https://fdroid.noql.net" contentName="URL" />
                </div>
                <div className="bg-black/30 p-2 rounded-md mt-2 flex items-center justify-between scale-95 transform">
                  <code className="text-xs text-green-400/70 font-mono break-all">0C00898126DF6E2BAAE76ED58D0269B8FBB42FE3DE4B3627DF28ED27CC5E7A02</code>
                  <CopyButton textToCopy="0C00898126DF6E2BAAE76ED58D0269B8FBB42FE3DE4B3627DF28ED27CC5E7A02" contentName="Fingerprint" />
                </div>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 4: Refresh Repositories</p>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 5: Find Applications</p>
                <p>Search for the app you want to install from the noql.net repository</p>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-green-100 mb-1">Step 6: Install App</p>
